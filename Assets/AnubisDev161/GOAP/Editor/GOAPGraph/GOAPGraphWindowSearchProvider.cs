...
namespace GOAP.GOAPGraph.Editor
{
    ...
    public class GOAPGraphWindowSearchProvider : ScriptableObject, ISearchWindowProvider
    {
        public GOAPGraphView graph;
        ...
        public List<SearchTreeEntry> CreateSearchTree(SearchWindowContext context)
        {
            ...
            AddAllNodesToElements();
            SortElements();
            return CreateTree(tree);
        }

        private void AddAllNodesToElements()
        {
        ...
        private List<SearchTreeEntry> CreateTree(List<SearchTreeEntry> tree)
        {
